...
def _prepare_generate_chain_and_inputs(doc: DocItem, context_str: str, config: Config) -> Tuple[Any, Dict[str, Any]]:
...
async def async_generate_docs(context: List[Dict[str, str]], config: Config, docs_to_generate: List[DocItem]) -> List[str]:
